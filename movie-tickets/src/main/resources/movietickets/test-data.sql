...
insert into t_seats(posx, posy, seat, cinema_id ) values (1, 1, true, 1);
insert into t_seats(posx, posy, seat, cinema_id ) values (1, 2, true, 1);
insert into t_seats(posx, posy, seat, cinema_id ) values (1, 3, true, 1);
insert into t_seats(posx, posy, seat, cinema_id ) values (2, 1, true, 1);
insert into t_seats(posx, posy, seat, cinema_id ) values (2, 2, true, 1);
insert into t_seats(posx, posy, seat, cinema_id ) values (2, 3, true, 1);
insert into t_seats(posx, posy, seat, cinema_id ) values (3, 1, true, 1);
insert into t_seats(posx, posy, seat, cinema_id ) values (3, 2, true, 1);
insert into t_seats(posx, posy, seat, cinema_id ) values (3, 3, true, 1);

insert into t_seats(posx, posy, seat, cinema_id ) values (1, 1, true, 2);
insert into t_seats(posx, posy, seat, cinema_id ) values (1, 2, true, 2);
insert into t_seats(posx, posy, seat, cinema_id ) values (1, 3, true, 2);
insert into t_seats(posx, posy, seat, cinema_id ) values (2, 1, true, 2);
insert into t_seats(posx, posy, seat, cinema_id ) values (2, 2, true, 2);
insert into t_seats(posx, posy, seat, cinema_id ) values (2, 3, true, 2);
insert into t_seats(posx, posy, seat, cinema_id ) values (3, 1, true, 2);
insert into t_seats(posx, posy, seat, cinema_id ) values (3, 2, true, 2);
insert into t_seats(posx, posy, seat, cinema_id ) values (3, 3, true, 2);

insert into t_seats(posx, posy, seat, cinema_id ) values (1, 1, true, 3);
insert into t_seats(posx, posy, seat, cinema_id ) values (1, 2, true, 3);
insert into t_seats(posx, posy, seat, cinema_id ) values (1, 3, true, 3);
insert into t_seats(posx, posy, seat, cinema_id ) values (2, 1, true, 3);
insert into t_seats(posx, posy, seat, cinema_id ) values (2, 2, true, 3);
insert into t_seats(posx, posy, seat, cinema_id ) values (2, 3, true, 3);
insert into t_seats(posx, posy, seat, cinema_id ) values (3, 1, true, 3);
insert into t_seats(posx, posy, seat, cinema_id ) values (3, 2, true, 3);
insert into t_seats(posx, posy, seat, cinema_id ) values (3, 3, true, 3);